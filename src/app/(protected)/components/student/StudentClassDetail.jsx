...
export default function StudentClassDetail({ clsData = {}, filesData = [] }) {
  const cls = {
    id: clsData.id || "",
    classTitle: clsData.classTitle || "Minha Turma de Inglês — A1",
    teachers: clsData.teachers || ["Rafael Martins"],
    ...
    <div className="max-w-6xl mx-auto p-6">
      <header className="border rounded-xl p-5 shadow-sm bg-white dark:bg-neutral-900 dark:border-neutral-800">
        <div className="flex items-start justify-between gap-4">
          ...
          <span className="text-xs px-2 py-1 rounded-full border bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950/30 dark:text-emerald-300 dark:border-emerald-900">
            {cls.status}
          </span>
        </div>
      </header>
      ...
      <section className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <aside className="space-y-6">
          <div className="border rounded-xl p-5 shadow-sm bg-white dark:bg-neutral-900 dark:border-neutral-800">
            <h2 className="flex items-center gap-2 text-base font-semibold text-neutral-900 dark:text-neutral-100">Visão Geral</h2>
